...
function getConfigError() {
  ...
  if (!supabaseUrl.startsWith('https://') || !supabaseUrl.includes('.supabase.co')) {
    return 'VITE_SUPABASE_URL non valida. Deve essere simile a https://xxxx.supabase.co.';
  }
  if (supabaseAnonKey.startsWith('sb_secret_')) {
    return 'Stai usando una Secret Key. Nel frontend devi usare la Publishable Key o la anon public key.';
  }
