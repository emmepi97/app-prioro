  ...
  return <main className="app-shell">
    <div className="app-sticky-head">
      <header className="topbar unified-menu">
        ...
        <div className="top-actions desktop-actions"><button className="soft-btn" onClick={() => { setOnboardingStep(0); setView(onboardingSteps[0].view); setShowOnboarding(true); }}>Tutorial</button><button className="soft-btn" onClick={exportExcel}><Download size={16}/>Excel</button><button className="logout-btn desktop-logout" onClick={() => supabase.auth.signOut()}><LogOut size={16}/>Esci</button></div>
      </header>
      {mobileMenuOpen && <div className="mobile-menu-fullpage" role="dialog" aria-modal="true" aria-label="Menu mobile">
        <div className="mobile-menu-fullpage-inner">
          ...
          <button onClick={() => { setOnboardingStep(0); setView(onboardingSteps[0].view); setShowOnboarding(true); setMobileMenuOpen(false); }}>Tutorial</button>
  ...
  return <div className="panel premium-panel review-wide premium-stats-block">
    ...
    {!isPremium ? <div className="premium-locked-note compact-lock">Sblocca Premium per PrioWeek Score, streak, trend, procrastinazione e statistiche evolute.</div> : <>
      ...
      <div className="premium-insight-box">
        ...
        <span>Il PrioWeek Score è una metrica interna calcolata da completamento, costanza, trend e procrastinazione. Le funzionalità esistenti non sono state modificate.</span>
      </div>
