            ...
            <DropZone day="" hoverDay={hoverDay} className="dropzone backlog-zone">
              <div className="backlog-list backlog-list-horizontal">
                {backlogTasks.length ? backlogTasks.map(task => (
                  <BacklogTask key={task.id} task={task} category={categoryMap[task.category_id]} goal={goalMap[task.goal_id]} draggedTaskId={draggedTaskId} onDragStart={startTaskDrag} onDelete={deleteTask} onEdit={editTaskTitle} />
                  ...
                  <DropZone key={day} day={day} hoverDay={hoverDay} className={`day-column ${index === selectedDayIndex ? 'mobile-active' : ''}`}>
                    ...
                    <div className="planned-list">
                      {dayTasks.length ? dayTasks.map(task => (
                        <PlannedTask key={task.id} task={task} category={categoryMap[task.category_id]} goal={goalMap[task.goal_id]} draggedTaskId={draggedTaskId} onDragStart={startTaskDrag} onArchive={archiveTask} onEdit={editTaskTitle} />
...
function BacklogTask({ task, category, goal, draggedTaskId, onDragStart, onDelete, onEdit }) {
...
function PlannedTask({ task, category, goal, draggedTaskId, onDragStart, onArchive, onEdit }) {
