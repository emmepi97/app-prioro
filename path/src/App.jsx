...
function DualBarList({ rows, empty = 'Nessun dato disponibile.' }) {
  ...
  return <div className="dual-bar-list clean-dual-bar-list">{rows.length ? rows.map(r => <div className="dual-bar-row clean-dual-bar-row" key={r.label}>
    ...
    <div className="dual-bars clean-dual-bars">
      <div className="dual-track-row"><div className="dual-track"><i className="productive-bar" style={{ width: barWidth(r.completed || 0) }} /><span className="bar-value">{r.completed || 0}</span></div></div>
      <div className="dual-track-row"><div className="dual-track"><i className="procrastination-bar" style={{ width: barWidth(r.procrastinated || 0) }} /><span className="bar-value">{r.procrastinated || 0}</span></div></div>
    </div>
