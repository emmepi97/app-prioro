...
function AuthGate() {
  ...
  const [demoTasks, setDemoTasks] = useState(['Preparare report VSL', 'Chiamare fornitore', 'Allenamento squadra', 'Revisione budget']);
  const [demoWeek, setDemoWeek] = useState({ LUN: ['Report VSL'], MAR: [], MER: ['Fornitore'], GIO: [], VEN: ['Allenamento'] });
  ...
  function resetDemo() {
    setDemoTasks(['Preparare report VSL', 'Chiamare fornitore', 'Allenamento squadra', 'Revisione budget']);
    setDemoWeek({ LUN: ['Report VSL'], MAR: [], MER: ['Fornitore'], GIO: [], VEN: ['Allenamento'] });
  }
        ...
        <section className="landing-v42-demo" aria-label="Demo PrioWeek">
          <div className="demo-main-card">
            <div className="demo-main-head">
              <div><p className="eyebrow">Demo</p><h2>Trascina una attività nella settimana.</h2></div>
            ...
            <div className="demo-workspace">
              <div className="demo-backlog" onDragOver={event => event.preventDefault()} onDrop={event => returnDemoTask(event.dataTransfer.getData('text/plain'))}>
                ...
                <p>Prendi una card e spostala su un giorno.</p>
