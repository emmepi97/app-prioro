...
function DualBarList({ rows, empty = 'Nessun dato disponibile.' }) {
  ...
  return <div className="dual-bar-list clean-dual-bar-list">{rows.length ? rows.map(r => <div className="dual-bar-row clean-dual-bar-row" key={r.label}>
    ...
    <div className="dual-bars clean-dual-bars">
      <div className="dual-track-row"><div className="dual-track"><span className="bar-fill-value" style={{ width: barWidth(r.completed || 0) }}><i className="productive-bar" /><b>{r.completed || 0}</b></span></div></div>
      <div className="dual-track-row"><div className="dual-track"><span className="bar-fill-value" style={{ width: barWidth(r.procrastinated || 0) }}><i className="procrastination-bar" /><b>{r.procrastinated || 0}</b></span></div></div>
    </div>
