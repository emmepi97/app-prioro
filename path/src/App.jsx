...
function Prioro({ session }) {
  ...
  return <main className="app-shell">
    ...
    {view === 'planner' ? <>
      ...
      <section className="print-planner-panel">
        <div><p className="eyebrow">PDF</p><h2>Stampa planner</h2><p>Genera una versione compatta del planner, adattata su una pagina.</p></div>
        <button className="primary print-planner-btn" type="button" onClick={() => window.print()}>Stampa PDF</button>
      </section>
