                ...
                <DropZone key={day} day={day} dragId={dragId} onMove={moveTask} className="day-column">
                  ...
                  <div className="planned-list">
                    {dayTasks.length ? dayTasks.map(task => (
                      <PlannedTask key={task.id} task={task} category={categoryMap[task.category_id]} setDragId={setDragId} onArchive={archiveTask} />
...
function PlannedTask({ task, category, setDragId, onArchive }) {
  ...
  return (
    <div className="planned-task" draggable onDragStart={() => setDragId(task.id)}>
      ...
      <div className="planned-content">
        ...
        <small className="planned-category" style={{ '--cat-color': cat.color }}>{cat.name}</small>
      </div>
    </div>
  );
}
