...
function DualBarList({ rows, empty = 'Nessun dato disponibile.' }) {
  ...
  return <div className="dual-bar-list clean-dual-bar-list">{rows.length ? rows.map(r => <div className="dual-bar-row clean-dual-bar-row" key={r.label}>
    ...
    <div className="dual-bars clean-dual-bars">
      <div className="dual-track-row"><div className="dual-track"><i className="productive-bar" style={{ width: barWidth(r.completed || 0) }} /></div><em>{r.completed || 0}</em></div>
      <div className="dual-track-row"><div className="dual-track"><i className="procrastination-bar" style={{ width: barWidth(r.procrastinated || 0) }} /></div><em>{r.procrastinated || 0}</em></div>
    </div>
