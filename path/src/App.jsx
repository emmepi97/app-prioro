  ...
  if (!session) {
    return <div className="landing-page landing-pro">
      ...
      <main className="landing-pro-main">
        ...
        <section className="landing-pro-section landing-pro-split">
          <div>
            <p className="eyebrow">Perché PrioWeek</p>
            <h2>Non è una lista infinita. È una settimana leggibile.</h2>
            <p>Le attività non restano sparse: entrano in un flusso semplice fatto di elenco attività, giorni della settimana, ricorrenze e statistiche. Così capisci subito cosa fare, cosa hai rimandato e dove stai caricando troppo.</p>
          </div>
          <div className="landing-pro-checks">
            <div><strong>Elenco attività</strong><span>Raccogli tutto ciò che devi fare prima di decidere quando farlo.</span></div>
            <div><strong>Settimana drag & drop</strong><span>Sposta le attività nei giorni giusti senza cambiare schermata.</span></div>
            <div><strong>Futuro e Ogni giorno</strong><span>Separa ciò che è ricorrente da ciò che vuoi ricordare più avanti.</span></div>
            <div><strong>Statistiche operative</strong><span>Misura completamento, procrastinazione, categorie e giorni più produttivi.</span></div>
          </div>
        </section>
        ...
        <section className="landing-pro-section">
          <div className="landing-section-title">
            ...
            <h2>Dal caos al piano settimanale in tre passaggi.</h2>
          </div>
          <div className="landing-steps-grid">
            <div><span>01</span><strong>Scrivi le attività</strong><p>Aggiungi titolo, categoria, priorità e note. Le attività partono dall'elenco, senza obbligarti a decidere subito il giorno.</p></div>
            <div><span>02</span><strong>Distribuisci la settimana</strong><p>Trascina le attività su lunedì, martedì, mercoledì o negli altri contenitori. Il piano resta visivo e facile da riorganizzare.</p></div>
            <div><span>03</span><strong>Controlla l'andamento</strong><p>Segna le attività fatte e leggi cosa stai completando, cosa stai rimandando e quali categorie pesano di più.</p></div>
          </div>
        </section>

        <section className="landing-pro-section landing-pro-premium">
          <div>
            <p className="eyebrow">Free e Premium</p>
            <h2>Parti gratis, sblocchi solo quando ti serve di più.</h2>
            <p>Il piano gratuito resta utile per organizzare la settimana. Premium aggiunge ricorrenze, insight più profondi, PrioWeek Score e strumenti pensati per chi usa davvero il planner ogni giorno.</p>
          </div>
          <div className="landing-pricing-mini">
            <div><strong>Free</strong><ul><li>Planner settimanale</li><li>Categorie</li><li>PDF ed Excel</li><li>Statistiche base</li></ul></div>
            <div className="featured"><strong>Premium</strong><ul><li>Ricorrenze</li><li>PrioWeek Score</li><li>Heatmap e trend</li><li>Insight evoluti</li></ul></div>
          </div>
        </section>

        <section className="landing-pro-section landing-final-lite">
          <div>
            <p className="eyebrow">Inizia ora</p>
            <h2>Costruisci la tua settimana prima che la settimana decida per te.</h2>
          </div>
          <button type="button" className="primary" onClick={() => setMode('register')}>Crea il tuo planner gratis</button>
        </section>
      </main>
    </div>;
  }
