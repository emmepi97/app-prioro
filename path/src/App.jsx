        ...
        <aside className="sidebar">
          <section className="panel minimal-panel">
            ...
            <form onSubmit={addTask} className="quick-form">
              ...
              <select value={newGoalForTask} onChange={e => setNewGoalForTask(e.target.value)}>
                <option value="">Nessun obiettivo collegato</option>
          ...
          <section className="panel minimal-panel goals-panel">
            ...
            <form className="goal-form" onSubmit={addGoal}>
              <input value={goalTitle} onChange={e => setGoalTitle(e.target.value)} placeholder="Nuovo obiettivo medio/lungo periodo" />
              <div className="form-grid">
              ...
              <button className="soft-btn" type="submit">+ Obiettivo</button>
            </form>
