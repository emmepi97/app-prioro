  ...
  if (!session) {
    return <div className="landing-page landing-pro">
      ...
      <main className="landing-pro-main">
        ...
        <section className="landing-pro-demo">
<div className="demo-board">
<div className="demo-tasks"><h3>Elenco attività</h3><div>Preparare report VSL</div><div>Chiamare fornitore</div><div>Allenamento squadra</div><div>Revisione budget</div></div>
<div className="demo-week"><h3>Settimana</h3><div className="demo-days"><span>Lun<br/>Report</span><span>Mar</span><span>Mer<br/>Fornitore</span><span>Gio</span><span>Ven<br/>Allenamento</span></div></div>
</div>
<div className="demo-kpis"><div><b>91</b><span>PrioWeek Score</span></div><div><b>87%</b><span>Attività completate</span></div><div><b>12%</b><span>Procrastinazione</span></div></div>
<section className="landing-final-lite"><div><p className="eyebrow">Inizia ora</p><h2>Prendi il controllo della tua settimana.</h2></div><button type="button" className="primary" onClick={() => setMode('register')}>Crea il tuo planner gratis</button></section>
</main>
    </div>;
  }
