      ...
      <main className="landing-pro-main">
        <section className="landing-v42-hero">
          ...
          <div className="landing-v42-actions">
            <button type="button" className="primary" onClick={() => setMode('register')}>Inizia gratis</button>
        ...
        <section className="landing-v43-info">
          <div className="landing-v43-info-head">
            <p className="eyebrow">Cosa puoi fare</p>
            <h2>Una home semplice, ma con il prodotto al centro.</h2>
          </div>
          <div className="landing-v43-grid">
            <div><strong>Organizza le attività</strong><p>Raccogli tutto in un elenco chiaro prima di decidere quando farlo.</p></div>
            <div><strong>Pianifica la settimana</strong><p>Distribuisci le attività nei giorni e ripianifica quando cambia qualcosa.</p></div>
            <div><strong>Monitora il carico</strong><p>Leggi completamento, procrastinazione e categorie più presenti.</p></div>
          </div>
        </section>
        ...
        <section className="landing-v42-auth">
          <div>
            <p className="eyebrow">Accesso</p>
            <h2>{mode === 'login' ? 'Bentornato' : 'Crea il tuo planner'}</h2>
            <p>{mode === 'login' ? 'Entra nel planner e continua la tua settimana.' : 'Parti gratis e organizza subito le attività.'}</p>
          </div>
        ...
        <section className="landing-v42-final">
          ...
          <button type="button" className="primary" onClick={() => setMode('register')}>Crea account gratuito</button>
        </section>
      </main>
    </div>;
  }
