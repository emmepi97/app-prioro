...
Aggiunta una nuova sezione `FUTURO` sotto `OGNI GIORNO`. Serve per parcheggiare cose da ricordare ma da fare prossimamente. Le attività possono essere trascinate dentro e fuori da `FUTURO`, modificate con doppio click ed eliminate come le altre attività.

## Aggiornamento mobile UX

Migliorato l'utilizzo da mobile:
- doppio tap su un'attività apre una tendina/pannello dal basso per modificare testo, categoria, obiettivo, priorità e note;
- da mobile puoi trascinare un'attività direttamente sul pulsante del giorno, per esempio da Lunedì al pulsante Sabato;
- durante il trascinamento il pulsante del giorno si evidenzia per indicare la destinazione;
- su desktop resta disponibile la modifica inline con doppio click.
